...
class RobotController(Node):
    ...
    def move_to_target(self):
        ...
        angle = math.atan2(target_y - current_y, target_x - current_x) - current_theta
        ...
        if distance < 0.01:
            ...
            if abs(angle_diff) > 0.1:  
                angular_velocity = 0.2 if angle_diff > 0 else -0.2  
    ...
    def move_forward(self, linear_velocity):
        ...
        self.publisher_.publish_(self.twist_msg_)
